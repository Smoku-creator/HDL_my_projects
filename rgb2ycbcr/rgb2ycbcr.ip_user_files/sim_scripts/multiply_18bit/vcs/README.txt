...
#
# Generated by export_simulation on Tue Apr 18 20:19:07 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './multiply_18bit.sh' script.

./multiply_18bit.sh -reset_run
...
./multiply_18bit.sh -noclean_files

For more information on the script, please type './multiply_18bit.sh -help'.
